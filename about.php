<main>
    ...
    <!--? About Area Start-->
    <div class="support-company-area pt-100 pb-100 section-bg fix" data-background="assets_user/img/gallery/section_bg02.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="assets_user/img/gallery/about.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-4">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets_user/img/gallery/team2.png" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-4">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets_user/img/gallery/team3.png" alt="">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Ethan Welch</a></h3>
                            <span>UX Designer</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-4">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="assets_user/img/gallery/team1.png" alt="">
                        </div>
                        <div class="team-caption">
                            <h3><a href="#">Ethan Welch</a></h3>
                            <span>UX Designer</span>
