            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="assets_user/img/logo/logo2_footer.png" alt=""></a>
                                </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="assets_user/img/gallery/footer_post1.png" alt="">
                                </div>
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="assets_user/img/gallery/footer_post2.png" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon | 2 hours ago</p>
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="assets_user/img/gallery/footer_post3.png" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon | 2 hours ago</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            <div class="banner">
                                <img src="assets_user/img/gallery/body_card4.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Date Picker -->
<script src="./assets_user/js/gijgo.min.js"></script>
